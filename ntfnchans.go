...
var ntfnChans struct {
	...
	reorgChanWiredDB                  chan *hcsqlite.ReorgData
...
func makeNtfnChans(cfg *config) {
	...
	ntfnChans.reorgChanWiredDB = make(chan *hcsqlite.ReorgData, reorgBuffer)
	...
	// 	ntfnChans.relevantTxMempoolChan = make(chan *hcutil.Tx, relevantMempoolTxChanBuffer)
	// }

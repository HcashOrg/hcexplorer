...
const (
	defaultConfigFilename = "hcexplorer.conf"
	defaultLogLevel       = "info"
	defaultLogDirname     = "logs"
	defaultLogFilename    = "hcexplorer.log"
)
...
var (
	...
	defaultPGUser   = "hcexplorer"
	defaultPGPass   = ""
	defaultPGDBName = "hcexplorer"
)
...
type config struct {
	...
	DBFileName         string `long:"dbfile" description:"SQLite DB file name (default is hcexplorer.sqlt.db)."`
